        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center group">
              <img 
                src="/images/brands/doctor-in-logo-2.png" 
                alt="Doctor In Logo" 
          ...
          <div className="space-y-8">
            ...
            <div className="flex bg-surface/5 border border-surface/10 rounded-2xl p-1 focus-within:border-accent/30 transition-colors">
              ...
              />
              <button aria-label="Subscribe to newsletter" className="bg-accent hover:bg-accent/80 text-secondary p-2.5 rounded-xl transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent">
                <Send size={18} />
              </button>
            </div>
          </div>
